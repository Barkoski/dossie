...
2. **Grafo do caso**
3. **Tabela de provas** — com busca por texto e filtro por grau
...
Layout dirigido por forcas em JavaScript puro, aproximadamente 200 iteracoes calculadas na carga, depois estatico. Para um caso tipico — dezenas de nos, nao milhares — isso basta e roda instantaneo.
...
Acima de aproximadamente 30 nos, agrupar por tipo em vez de desenhar tudo: o grafo perde utilidade antes de perder desempenho.

## Barras de requisitos

Barra horizontal por requisito, largura proporcional a quantidade de provas que o sustentam, cor pela situacao. Requisito sem prova aparece como barra vazia com contorno — visualmente e o buraco do caso, e tem que saltar aos olhos.
